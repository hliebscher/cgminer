...
#define BITBURNER_INDEX_GET_QUEUEABLE 6
#define BITBURNER_INDEX_SET_DIFFICULTY 7
...
#define USB_PARSE_COMMANDS(USB_ADD_COMMAND) \
	...
	USB_ADD_COMMAND(C_BB_GET_QUEUEABLE, "GetQueueable") \
	USB_ADD_COMMAND(C_BB_SET_DIFFICULTY, "SetDifficulty") \
